...
namespace Facelift
{
    public class PawnRenderNode_Brow : PawnRenderNode_FaceFeature
    {
        public PawnRenderNode_Brow(Pawn pawn, PawnRenderNodeProperties props, PawnRenderTree tree) : base(pawn, props, tree)
        {
        }
